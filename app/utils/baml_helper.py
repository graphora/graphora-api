...
def create_baml_client(api_key: str, model_name: str = "gemini-1.5-pro") -> baml_py.ClientRegistry:
    """
...
def configure_baml_client_for_refinement(api_key: str, model_name: str = "gemini-1.5-pro") -> baml_py.ClientRegistry:
    """
