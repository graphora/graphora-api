    ...
    async def track_function_call(self, function_name: str, result: Any) -> None:
        ...
        try:
            ...
            if not success and function_log.calls:
                ...
                failed_calls = [call for call in function_log.calls if not call.selected]
            ...
            logger.info(f"Tracked BAML usage: {function_name} - {input_tokens + output_tokens} tokens")
    ...
    def get_usage_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            summary = {
                ...
                "total_tokens": (total_usage.input_tokens or 0) + (total_usage.output_tokens or 0),
                ...
                "providers_used": list(set([
                    call.provider for log in self.collector.logs 
                    for call in log.calls
                ])) if self.collector.logs else []
            }
