...
class BamlStreamClient:
    ...
    def RefineSchemaConversational(
        ...
        current_schema: str,user_request: str,refinement_count: int,previous_requests_summary: str,changes_history_summary: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.SchemaRefinementResponse, types.SchemaRefinementResponse]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.SchemaRefinementResponse, types.SchemaRefinementResponse](
        raw,
