...
async def test_quality_system():
    ...
    try:
        ...
        print(f"✅ Created sample knowledge graph: {len(sample_nodes)} nodes, {len(sample_relationships)} relationships")
        ...
        quality_results = await validator.validate_extraction(knowledge_graph, "test_transform_123")
        ...
        for entity_type, severity_counts in quality_results.entity_quality_summary.items():
